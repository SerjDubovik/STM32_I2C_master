...
void init_GPIO(void)
{
	...
	*/
	...
	GPIOB->CRL |=  GPIO_CRL_CNF6;  						// альтернативная функция, симетричный		!!!!!!! было GPIO_CRL_CNF6_1 так не работает
	...
	GPIOB->CRL |=  GPIO_CRL_CNF7;  						// альтернативная функция, симетричный		!!!!!!! было GPIO_CRL_CNF7_1 так не работает
